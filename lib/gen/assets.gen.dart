...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/cancel_icon.png
  ...
  /// File path: assets/icons/marker_icon.png
  AssetGenImage get markerIcon =>
      const AssetGenImage('assets/icons/marker_icon.png');
  ...
  AssetGenImage get sortIcon =>
      const AssetGenImage('assets/icons/sort_icon.png');
  ...
  AssetGenImage get tulipIcon =>
      const AssetGenImage('assets/icons/tulip_icon.png');

  /// File path: assets/icons/tune_icon.png
  AssetGenImage get tuneIcon =>
      const AssetGenImage('assets/icons/tune_icon.png');
