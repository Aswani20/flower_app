...
// in flower_app/test/project_layers/domain_layer/usecase/login_usecase/login_usecase_test.dart.
...
class MockLoginRepository extends _i1.Mock implements _i3.LoginRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failures, _i6.LoginResponse>> login({
    required _i7.LoginRequest? request,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#login, [], {#request: request}),
            returnValue:
                _i4.Future<_i2.Either<_i5.Failures, _i6.LoginResponse>>.value(
                  _FakeEither_0<_i5.Failures, _i6.LoginResponse>(
                    this,
                    Invocation.method(#login, [], {#request: request}),
                  ),
                ),
          )
          as _i4.Future<_i2.Either<_i5.Failures, _i6.LoginResponse>>);
}
